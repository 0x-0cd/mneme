...
| 文档 | 主题 | 结论 |
|:----|:----|:----:|
| 01-brainstorming-record | 需求脑暴 | 定位为纯离线、即插即用的 AI Agent 记忆系统；确定差异化方向：端侧优先、记忆质量管理、扩展接口 |
| 02-competitive-landscape | 竞品分析 | Mem0 与 Letta 为两大竞品；边缘优先和记忆质量是未充分竞争的差异化空间 |
